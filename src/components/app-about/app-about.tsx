	...
	render() {
		return (
			<div class="about__base">
				...
				<div class="about__text">
					<sl-button-group>
						<sl-button variant="text" href="https://opencv.org/" target="blank">
							OpenCV
						</sl-button>
					</sl-button-group>
				</div>
				...
				<div class="about__text">
					<sl-button-group>
						<sl-button variant="text" href="https://github.com/recette-lemon/Haar-Cascade-Anime-Eye-Detector" target="blank">
							眼部模型
						</sl-button>
						<sl-button variant="text" href="https://github.com/nagadomi/lbpcascade_animeface" target="blank">
							脸部模型
						</sl-button>
					</sl-button-group>
				</div>
				...
				<div class="about__text">
					<sl-button-group>
						<sl-button variant="text" href="https://stenciljs.com/" target="blank">
							Stencil
						</sl-button>
						<sl-button variant="text" href="https://shoelace.style/" target="blank">
							Shoelace
						</sl-button>
					</sl-button-group>
				</div>
				...
				<div class="about__text">
					<sl-button-group>
						<sl-button variant="text" href="https://www.google.com/chrome/" target="blank">
							Chrome
						</sl-button>
						<sl-button variant="text" href="https://www.microsoft.com/edge" target="blank">
							Edge
						</sl-button>
						<sl-button variant="text" href="https://www.mozilla.org/firefox/new/" target="blank">
							Firefox
						</sl-button>
					</sl-button-group>
				</div>
				...
				<div class="about__text">
					<sl-button variant="text" href="https://www16.big.or.jp/~zun/" target="blank">
						上海アリス幻樂団
					</sl-button>
				</div>
			</div>
